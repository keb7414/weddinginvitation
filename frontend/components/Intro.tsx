  ...
  return (
    ...
    >
      <div className="text-center">
        <p
          className="text-xl tracking-[0.15em] text-ink opacity-0 animate-introUp"
          style={{ animationDelay: "0.15s", WebkitTextStroke: "0.35px #faf8f4" }}
        >
          {groom.name} <span className="mx-2 text-point">♥</span> {bride.name}
        </p>
        <p
          className="mt-5 font-hand text-4xl tracking-[0.08em] text-point/60 opacity-0 animate-introUp"
